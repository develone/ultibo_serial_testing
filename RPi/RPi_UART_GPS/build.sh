...
/home/pi/ultibo/core/fpc/bin/fpc -vi -B -Tultibo -Parm -CpARMV6 -WpRPIB @/home/pi/ultibo/core/fpc/bin/rpi.cfg -O2 UDPServerGPS.lpr
date
ls -la kernel.img checksum_ultibo.o libgps.a
